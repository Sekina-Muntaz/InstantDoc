...
public class DisplayHospitalReferralFragment extends Fragment implements MedicalNotesAdapter.OnDownloadPressed{
    ...
    public static final String TAG="Referrals";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(" Your Referrals");
            ...
            case MY_PERMISSIONS_WRITE_EXTERNAL: {
                ...
                if (grantResults.length > 0
                    ...
                    if (referralNoteDownloadUrl != null) {
                        startDownload(referralNoteDownloadUrl, "Referral Note");
                    }
                } else {
